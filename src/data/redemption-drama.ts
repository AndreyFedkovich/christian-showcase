...
export const introSlides: RedemptionDramaSlide[] = [
  ...
  },
  {
    ...
    focus: {
      ...
      explanation: 'Свет пришёл к своим, и свои не приняли. Призыв к метанойе — смене мышления.'
    },
    intensity: 'low'
  }
];
...
export const finaleSlides: RedemptionDramaSlide[] = [
  ...
  },
  {
    ...
    statements: [
      ...
      'Спасение валидировано. Это не просто прощение, это Новая Жизнь.'
    ],
    cry: 'Он воскрес!',
    focus: {
  ...
  },
  {
    ...
    plot: [
      ...
      'От «все идут к Иисусу» к «ученики идут в мир». Церковь получает власть «вязать и разрешать».'
    ],
