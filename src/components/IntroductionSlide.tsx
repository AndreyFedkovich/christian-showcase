      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-7 gap-12 items-center">
        ...
        <div className="lg:col-span-3 space-y-6 animate-in slide-in-from-left-8 duration-700">
          <div className="space-y-7">
            ...
            {slide.subtitle && (
              <p className="text-2xl text-accent font-sans font-semibold">
                {slide.subtitle}
              </p>
            )}
          </div>
          ...
          <div className="space-y-7">
            {slide.content.map((paragraph, index) => (
              <p 
                key={index} 
                className="text-xl text-muted-foreground font-sans leading-relaxed animate-in slide-in-from-left-8 duration-700"
